...
exp_name='mcmahanCNN_lr0.05_diri_a0.5_u10_b512'
python3 $main_path -n_rounds 1000 -n_users 10 -n_epochs 1 -eval_round 10 -model mcmahanCNN -opt sgd -lr 0.05 -lr_decay 0.99 -lr_decay_round 5 -avg_method Equal \
...
gpu_id=1
group_name='LeNet_Test'
exp_name='mcmahanCNN_lr0.075_diri_a0.5_u10_b2048'
python3 $main_path -n_rounds 1000 -n_users 10 -n_epochs 1 -eval_round 10 -model mcmahanCNN -opt sgd -lr 0.075 -lr_decay 0.99 -lr_decay_round 5 -avg_method Equal \
